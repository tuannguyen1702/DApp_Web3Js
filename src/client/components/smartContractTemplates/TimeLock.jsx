...
export default class TimeLock extends Component {
    constructor(props) {
        super(props)
    ...
    initFormModel() {
        ...
        self.form.onSuccess = function (form) {
            ...
            argumentArr.push(parseFloat(formData.lockPeriod) * 24 * 60 * 60)
    ...
    render() {
        ...
        return (
            <Form>
                ...
                <Row>
                    <Col xs="12" sm="6">
                        <TextField append={"Days"} field={self.form.$("lockPeriod")} />
                    </Col>
                    <Col xs="12" sm="6">
                    </Col>
                </Row>
